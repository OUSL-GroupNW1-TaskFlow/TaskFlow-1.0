@php
     ...
     *
     * NOTE FOR TEAM:
     * Do NOT hardcode dashboard routes.
     * Always use $dashboardRoute.
     */
    ...
    $dashboardRoute = match (true) {
        $authUser->hasRole('system_admin') => route('system.dashboard'),
        $authUser->hasRole('admin') => route('admin.dashboard'),
        $authUser->hasRole('agent') => route('agent.dashboard'),
        default => '#',
    };
@endphp
